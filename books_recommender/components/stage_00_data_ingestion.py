...
class DataIngestion:
    ...
    def download_data(self):
        ...
        try:
            ...
            logging.info(f"Downloading data from {dataset_url} info file {zip_file_path}")
            urllib.request.urlretrieve(dataset_url, zip_file_path)
            logging.info(f"Downloaded data from {dataset_url} info file {zip_file_path}")
    ...
    def extract_zip_file(self, zip_file_path: str):
        ...
        try:
            ...
            logging.info(f"Extraction zip file: {zip_file_path} into dir: {ingested_dir}")
